...
SMODS.Joker({
    ...
    calculate = function(self, card, context)
        ...
        if (context.playing_card_added and not context.blueprint) or context.forcetrigger then
            card.ability.extra.emult = Number.add(card.ability.extra.emult, Number.mul(card.ability.extra.gain, #context.cards))
        ...
        if context.remove_playing_cards and not context.blueprint then
            card.ability.extra.emult = Number.add(card.ability.extra.emult, Number.mul(card.ability.extra.gain, #context.removed))
