    ...
    loc_vars = function(_, _, card)
        return {
            vars = {
                ...
                card.ability.extra.immutable.joker_slots,
    ...
    calculate = function(_, card, context)
        if (context.end_of_round and context.cardarea == G.jokers and not context.blueprint and not context.retrigger_joker) or context.forcetrigger then
            SMODS.scale_card(card, {
                ...
                ref_value = "mult",
                scalar_table = {
                    empty_gain = (G.jokers.config.card_limit - #G.jokers.cards) * lenient_bignum(card.ability.extra.mult_gain),
                },
